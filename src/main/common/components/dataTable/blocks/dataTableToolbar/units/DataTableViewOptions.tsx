...
export function DataTableViewOptions<TData>({
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          >
            ...
            />
            <path
              d="M17.5 18.958H2.5C2.15833 18.958 1.875 18.6747 1.875 18.333C1.875 17.9913 2.15833 17.708 2.5 17.708H17.5C17.8417 17.708 18.125 17.9913 18.125 18.333C18.125 18.6747 17.8417 18.958 17.5 18.958Z"
              fill="#7E858E"
            />
          </svg>
      ...
      <DropdownMenuContent align="end" className="w-[150px] mx-10 ">
        <DropdownMenuLabel>
          {t("table.toolbar.viewOption.toggleColumns.title")}
        </DropdownMenuLabel>
        <DropdownMenuSeparator />
        {table
          .getAllColumns()
