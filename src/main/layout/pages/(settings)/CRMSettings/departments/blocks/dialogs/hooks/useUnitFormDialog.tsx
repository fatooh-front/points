...
import { useAddDepartment } from "@/main/global/api/restful/userManagmentAPI/CRMSettingsManager/CRMSettingsQuery";
...
export function useUnitFormDialog({ unit, type }: Props) {
  const { mutate: mutateAdd } = useAddDepartment();
