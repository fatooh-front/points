...
import { useGetAllDepartments } from "@/main/global/api/restful/userManagmentAPI/CRMSettingsManager/CRMSettingsQuery";
...
export default function useGetDataOfPage({ type }: ParamsQuery) {
  ...
  const {
    ...
    isLoading,
    error,
  } = useGetAllDepartments({ page: (page ?? 1) - 1, size: limit });
