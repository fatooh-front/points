...
import { useGetAllLimousines } from "@/main/global/api/restful/userManagmentAPI/LimousineManager/LimousineQuery";
...
export default function useGetDataOfPage() {
  ...
  const { data: data, isLoading, error } = useGetAllLimousines();
