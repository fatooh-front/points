...
import { useGetAllCategories } from "@/main/global/api/restful/userManagmentAPI/CategorieManager/CategorieQuery";
...
export default function useGetDataOfPage({ type }: ParamsQuery) {
  ...
  const { data: data, isLoading, error } = useGetAllCategories();
