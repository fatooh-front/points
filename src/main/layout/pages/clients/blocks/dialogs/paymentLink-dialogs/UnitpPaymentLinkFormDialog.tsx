...
import { useUnitPaymentLinkFormDialog } from "./hooks/useUnitPaymentLinkFormDialog";
...
export function UnitpPaymentLinkFormDialog({
  unit,
  type,
  btn = true,
  passedButton,
                ...
                <Form {...form}>
                  ...
                  >
                    <div className="flex flex-col md:flex-1 gap-y-3 ">
                      <TFormField
                        placeholder={t("من فضلك ادخل المبلغ المراد إرسالة")}
                        typeField="input"
                        form={form}
                        name="englishName"
                        label={t("المبلغ")}
                      ...
                      <div className=" mt-[24px]">
                        <TFormField
                          placeholder={t("ادخل الملاحظات إذا وجد")}
                          typeField="textarea"
                          form={form}
                          name="arabicName"
                          label={t("الملاحظات")}
