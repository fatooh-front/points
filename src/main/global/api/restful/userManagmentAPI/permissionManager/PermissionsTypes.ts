...
export type GetPermissionByIdProps = {
  ...
  groupId: GroupPermission;
  accountAdmin: UserPermission;
  serial: number;
  type: MethodPermission;
  created_at: string;
  updated_at: string;
  ...
  id: string;
  // ------------------------
  group: MethodPermission;
  orgCategory: MethodPermission;
  orgRegion: MethodPermission;
  portalPermission: MethodPermission;
  user: MethodPermission;
  // statistics: MethodPermission;
  // notification: MethodPermission;
