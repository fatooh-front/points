  ...
  return (
    <div
      ...
      className={cn(
        ...
        "inline-flex h-10 flex-0  items-center rounded-l-md border-input bg-transparent px-2 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
    ...
    return (
      <div
        ...
        className={cn(
          ...
          "flex items-center rounded-md border bg-white ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2"
        )}
      >
